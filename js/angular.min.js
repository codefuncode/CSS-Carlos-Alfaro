...
(function (w) {
	...
	function Be() {
		...
		if (!Wc) {
			...
			(ma = x(b) ? w.jQuery : b ? w[b] : void 0) && ma.fn.on ? (z = ma, O(ma.fn, {
				...
				for (var c,
					e = 0, f; null != (f = b[e]); e++)(c = ma._data(f, "events")) && c.$destroy && ma(f)
				...
				if (!m.get(a)) {
					...
					try {
						E(a) ? (c = ic(a), v.modules[a] = c, b = b.concat(g(c.requires))
							.concat(c._runBlocks), d(c._invokeQueue), d(c._configBlocks)) : C(a) ? b.push(n.invoke(a)) : I(a) ? b.push(n.invoke(a)) : sb(a, "module")
					} catch (e) {
						throw I(a) &&
			...
			function (b, d, c) {
				...
				function f(a) {
					if (a) {
						...
						var c;
						c = g.yOffset;
						C(c) ? c = c() : Zb(c) ? (c = c[0], c = "fixed" !== b.getComputedStyle(c)
		...
		this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, e, p, R, M, T, P, q) {
			...
			function da(a, b, c, d, e) {
				...
				return function (b, c, d) {
					...
					f || (f = (d = d && d[0]) ? "foreignobject" !== ya(d) && ia.call(d)
						.match(/SVG/) ? "svg" : "html" : "html");
					d = "html" !== f ? z(ka(f, z("<div>")
						.append(a)
						.html())) : c ? Sa.clone.call(a) : a;
					if (k)
						...
						compile: function () {
							return {
								pre: function (a, c, g) {
									...
									l && (g[e] = l(a), (c[e] || (c[e] = []))
										.$$inter = !0, (g.$$observers && g.$$observers[e].$$scope || a)
			...
			function ma(a, b, c) {
				...
				z.hasData(d) && (z.data(c, z.data(d)), z(d)
					.off("$destroy"));
	...
	function Bd(a, b, d) {
		...
		c && (a = "/" + a);
		a = ta(a);
		for (var c = (c && "/" === a.pathname.charAt(0) ? a.pathname.substring(1) : a.pathname)
			.split("/"), e = c.length; e--;) c[e] = decodeURIComponent(c[e]), d && (c[e] = c[e].replace(/\//g, "%2F"));
		d = c.join("/");
		b.$$path = d;
			...
			f.on("click", function (a) {
				...
				if (e && !a.ctrlKey && !a.metaKey && !a.shiftKey && 2 !== a.which && 2 !== a.button) {
					...
					if (!E(e) || !x(h.attr(e))) {
						...
						B(e) && "[object SVGAnimatedString]" === e.toString() && (e = ta(e.animVal)
							.href);
	...
	function Nf() {
		...
		this.$get = ["$filter", function (e) {
			function f(b, c) {
				...
				switch (typeof b) {
				case "string":
					return g = b = b.trim(), d = a[g], d || (d = new Nb(n), d = (new Mb(d, e, n))
						.parse(b), d.constant ? d.$$watchDelegate = m : d.oneTime ? d.$$watchDelegate = d.literal ? l : k : d.inputs && (d.$$watchDelegate = h), a[g] = d), p(d, c);
				case "function":
					return p(b, c);
				default:
					return p(D, c)
		...
		function g() {
			for (; !u && w.length;) {
				...
				if (!a.pur) {
					a.pur = !0;
					var c = a.value,
					c = "Possibly unhandled rejection: " + ("function" === typeof c ? c.toString()
						.replace(/ \{[\s\S]*$/, "") : x(c) ? "undefined" : "string" !== typeof c ? De(c, void 0) : c);
	...
	function Tf() {
		this.$get = ["$window", "$document", function (a, b) {
			...
			e = Z((/android (\d+)/.exec(L((a.navigator || {})
				.userAgent)) || [])[1]),
	...
	function Qd(a) {
		...
		return function (a, c, e) {
			...
			var f = c ? /\u00A4/g : /\s*\u00A4\s*/g;
			return null == a ? a : Ud(a, b.PATTERNS[1], b.GROUP_SEP, b.DECIMAL_SEP, e)
			.replace(f, c)
		}
	}
	...
	function Ud(a, b, d, c, e) {
		...
		if (f) k = "\u221e";
			...
			h = [];
			for (k.length >= b.lgSize && h.unshift(k.splice(-b.lgSize, k.length)
					.join("")); k.length > b.gSize;) h.unshift(k.splice(-b.gSize, k.length)
				.join(""));
	...
	function Rd(a) {
		...
		return function (c, d, f) {
			...
			r(h, function (b) {
				k = Rg[b];
				g += k ? k(c, a.DATETIME_FORMATS, m) : "''" === b ? "'" : b.replace(/(^'|'$)/g, "")
				.replace(/''/g, "'")
			});
			return g
		}
	...
	q.prototype = {
		...
		primary: function () {
			...
			this.expect("(") ? (a = this.filterChain(), this.consume(")")) : this.expect("[") ? a = this.arrayDeclaration() : this.expect("{") ? a = this.object() : this.selfReferential.hasOwnProperty(this.peek()
				.text) ? a = pa(this.selfReferential[this.consume()
		...
		object: function () {
			...
			if ("}" !== this.peekToken()
				...
				do {
					...
					this.peek()
					.constant ? (b.key = this.constant(), b.computed = !1, this.consume(":"), b.value = this.expression()) : this.peek()
	...
	of = ["$compile", function (a) {
		return {
			...
			link: function (b, d, c, e) {
				ia.call(d[0])
				.match(/SVG/) ?
				(d.empty(), a(fd(e.template, w.document)
	...
	mh = ["$element", "$scope", function (a, b) {
		...
		e.selectUnknownOrEmptyOption = function (a) {
			null == a && e.emptyOption ? (e.removeUnknownOption(), e.selectEmptyOption()) : e.unknownOption.parent()
			.length ? e.updateUnknownOption(a) : e.renderUnknownOption(a)
		};
		var g = !1,
		h = !1;
